...
!a.sEmptyTable&&(c&&"Pas de données trouvées dans la table"===b.sEmptyTable)&&E(a,a,"sZeroRecords","sEmptyTable");!a.sLoadingRecords&&(c&&"Loading..."===b.sLoadingRecords)&&E(a,a,"sZeroRecords","sLoadingRecords");a.sInfoThousands&&(a.sThousands=a.sInfoThousands);(a=a.sDecimal)&&db(a)}function eb(a){A(a,"ordering","bSort");A(a,"orderMulti","bSortMulti");A(a,"orderClasses","bSortClasses");A(a,"orderCellsTop","bSortCellsTop");A(a,"order","aaSorting");A(a,"orderFixed","aaSortingFixed");A(a,"paging","bPaginate");
...
oPaginate:{sFirst:"First",sLast:"Last",sNext:"Suivant",sPrevious:"Précedent"},sEmptyTable:"Aucune données trouvées dans la table",sInfo:"Affichage de _START_ à _END_ sur _TOTAL_ élements",sInfoEmpty:"Affichage 0 à 0 sur 0 élement",sInfoFiltered:"(filtered from _MAX_ total entries)",sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"Afficher _MENU_ élements",sLoadingRecords:"Loading...",sProcessing:"Processing...",sSearch:"Rechercher :",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"No matching records found"},oSearch:h.extend({},
